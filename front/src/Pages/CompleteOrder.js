...
const OrderSummary = () => {
    return (
        ...
        <div className="checkout-box shipping">
            <section id="step_2">
                ...
                <div className="box">
                                ...
                                <span className="radiobtn">
                                    <div className="module">
                                        <div className="module-title" style={{ marginTop: 0 }}>
                                            Delivery at Place<br />(freight cost will be included to your invoice)
                                        </div>
                                    </div>
                                </span>
                            </label>
                    ...
                    <div className="shipping-module">
                        <div className="module">
                            <label htmlFor="shipping-option-1">
                                <input type="radio" name="shipping" value="carrier_friday" id="shipping-option-1" className="refresh_total refresh_shipping ship_lock" />
                                <span className="radiobtn">
                                    <div className="module">
                                        <div className="module-title" style={{ marginTop: 0 }}>
                                            Delivery at carrier on Friday<br />(freight cost will be included to your invoice)
                                        </div>
                                    </div>
                                </span>
                            </label>
        ...
        <div className="checkout-box payment">
            <h3 className="step_title"><i className="las la-university"></i>Payment Method</h3>
                    ...
                    <div className="payment-module">
                        <div className="radio-holder">
                            <label htmlFor="payment_credit_card">
                                <input type="radio" name="payment" value="credit_card" checked id="payment_credit_card" />
        ...
        <div className="container">
            ...
            <div className="checkout-box totals">
              <div className="confirmation-check-totals">
                ...
                <div className="description button">
                  <input type="submit" border="0" alt="Confirm Order" value="Confirm Order" title="Confirm Order" className="shop-btn" id="confirm_order_submit" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="field agree-check-box" style={{ marginTop: '12px' }}>
            <div className="cboxcontainer d-flex flex-column">
              ...
              <label htmlFor="agreeterms" className="css-label">I agree with<a className="ml-1" href="https://www.fos-lighting.eu/gdpr.php" target="_blank" style={{ textDecoration: 'underline' }}> personal data terms</a></label>
            </div>
          </div>
          ...
          <div className="field agree-check-box">
            <div className="cboxcontainer d-flex flex-column">
              ...
              <label htmlFor="agreeterms_cooperations" className="css-label">I accept <a href="https://www.fos-lighting.eu/terms-of-cooperation-pr-3.html" target="_blank">cooperation terms</a></label>
            </div>
          </div>
          ...
          <div className="container coupon-main-cont" style={{ display: 'none' }}>
            ...
            <div className="checkout-box discount">
              <div className="discount-coupon-container">
                <div className="title"><i className="las la-percent"></i> </div>
