...
const MainHeader = () => {
    ...
    return (
        ...
        <SideMenu isOpen={isMenuOpen} isopen2={isMenuOpen2} onClose={() => toggleMenu(false)}/>
    ...
    <div className="col-auto icon search">
        ...
        <div className="col-auto cart-contain ">
                                <div className="shoppingcart toggler">
                                    <div className="shoppingpopup dynamic_content" >
                                        <div id="mini-shopping-cart-details-dynamic" onClick={toggleCart} className="details">
