...
$(document).ready(mobileMenuFunvtion);
$(window).on('resize',mobileMenuFunvtion);

function mobileMenuFunvtion() {
    if ($(window).width() < 991) {
        /* $('.side-menu.main-menu-container').remove();*/

        ddfullscreenmenu.init();
        $('#ulwrapper ul[style*="z-index: 100;"]').addClass('firstLevel');
